    ...
    <div className="flex flex-col gap-5">
      <Grid cols={2}>
        ...
        <Part name="InlineAlert" when="Use it inside a card, next to the thing it is about.">
          <InlineAlert tone="info" detail="Recalculated overnight from the latest CDSM export.">
      ...
      <Grid cols={2}>
        <Part name="Callout" when="Use it once per section of a report, right after the chart it is about.">
          <Callout tone="brand">
            Tier 1 sites are enrolling 40% above the study average. Tier 2 is not worth a separate push.
          </Callout>
        </Part>
