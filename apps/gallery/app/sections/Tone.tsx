...
const STUDIES: Study[] = [
  { id: "M26-092", name: "Atlas", phase: "Phase 3", sites: 84, enrolled: 612, status: "On plan", tone: "ok", note: "Enrolment is tracking two weeks ahead of the committed date." },
  { id: "M26-114", name: "Beacon", phase: "Phase 2", sites: 31, enrolled: 188, status: "At risk", tone: "warn", note: "Four sites have not activated. The date holds if two of them open by March." },
  { id: "M25-077", name: "Cascade", phase: "Phase 3", sites: 57, enrolled: 94, status: "Behind plan", tone: "error", note: "Seventy-four weeks behind the committed date. Site selection is being redone." },
  { id: "M26-141", name: "Delta", phase: "Phase 1", sites: 12, enrolled: 47, status: "In review", tone: "info", note: "Figures were recalculated overnight and have not been checked by the study team." },
  { id: "M25-203", name: "Ember", phase: "Phase 2", sites: 44, enrolled: 301, status: "On plan", tone: "ok", note: "No change since the last review." },
];
